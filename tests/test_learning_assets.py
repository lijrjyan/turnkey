...
def test_detector_learning_assets_cover_new_public_methods() -> None:
    expected = (
        Path("configs/runs/smoke_perplexity.yaml"),
        Path("configs/runs/smoke_self_exam.yaml"),
        Path("configs/runs/smoke_llamaguard_detector.yaml"),
        Path("docs/guides/model_based_filters.md"),
    )
